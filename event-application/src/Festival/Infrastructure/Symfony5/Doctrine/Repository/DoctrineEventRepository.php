...
class DoctrineEventRepository extends ServiceEntityRepository implements EventRepository
{
	...
	public function getEventList(): array
	{
		...
		return array_map( function ( EventEntity $event ) {
			$returnedEvent = new Event( $event->getName(), $event->getDescription(), $event->getLocation(),
				$event->getDate(), $event->getAttendee(), );
	...
	public function getEvent( int $eventId ): ?Event
	{
		...
		return $event ? new Event( $event->getName(), $event->getDescription(), $event->getLocation(),
			$event->getDate(), $event->getAttendee() ) : null;
	}
	...
	public function updateEvent( Event $event ): Event
	{
		...
		return new Event( $eventToUpdate->getName(), $eventToUpdate->getDescription(), $eventToUpdate->getLocation(),
			$eventToUpdate->getDate(), $eventToUpdate->getAttendee() );
	}
