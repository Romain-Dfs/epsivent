...
//        On récupère l'access token et le refresh token de l'utilisateur
        ...
        $this->refreshToken = $authEndpointResponse->getRefreshToken();
...
//        Si aucun utilisateur est présent en DB
    ...
    {
        return new RedirectResponse("/tokeninfo?access_token=".$this->accessToken."&refresh_token=".$this->refreshToken);
    }
